...
def jpg2png(origImgName, newImgName): #jpg轉png
    try:
        im = Image.open(origImgName)
        im.save(newImgName, "png")
    except FileNotFoundError as fnfe:
        print(fnfe)

def png2jpg(origImgName, newImgName): #png轉jpg
    try:
        im = Image.open(origImgName)
        im = im.convert("RGB")
...
def imgConvert(origImgName, newImgName, newImgFormat): 
    try:
        im = Image.open(origImgName)
